...
def test_shipped_robots_are_clean():
    ...
    for rel in ("projects/robots/omnisim/omniarm6/omniarm6.urdf",
                ...
                # The Deep Robotics packages are generated by make_urdfs.py from
                # upstream files that did NOT pass (zero foot inertias, a
                # full-width period in a limit); this pins that the generator's
                # fixes hold across a refresh.
                "projects/robots/deep_robotics/lite3/urdf/lite3.urdf",
                "projects/robots/deep_robotics/x30/urdf/x30.urdf",
                "projects/robots/deep_robotics/m20/urdf/m20.urdf",
                "projects/robots/deep_robotics/m20s/urdf/m20s.urdf",
                "projects/robots/deep_robotics/m20_piper/urdf/m20_piper.urdf",
                "projects/robots/deep_robotics/dr02/urdf/dr02_std.urdf",
                "projects/robots/deep_robotics/dr02/urdf/dr02_pro.urdf",
                "projects/robots/deep_robotics/dr02/urdf/dr02_pro_fixed_wrists.urdf"):
        path = root / rel
